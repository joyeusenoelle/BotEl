...
class BotElINGen():
    ...
    def __init__(self, prnt=None, maxforces=None):
        ...
        self.types = {"angel":[str(b"Serꙮph","utf-8"),"Cherub","Ofanite","Elohite","Malakite","Kyriotate","Mercurian","Bright Lilim"],
                      "demon":[str(b"Balserꙮph","utf-8"),"Djinn","Calabite","Habbalite","Lilim","Shedite","Impudite"]}
