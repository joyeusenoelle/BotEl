...
class BotElINGen():
    ...
    def __init__(self, maxforces=None):
        ...
        self.types = {"angel":["Seraph","Cherub","Ofanite","Elohite","Malakite","Kyriotate","Mercurian","Bright Lilim"],
                      "demon":["Balseraph","Djinn","Calabite","Habbalite","Lilim","Shedite","Impudite"]}
